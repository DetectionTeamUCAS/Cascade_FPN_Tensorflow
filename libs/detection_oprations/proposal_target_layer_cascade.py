...
def proposal_target_layer(rpn_rois, gt_boxes, fg_threshold, stage):
    """
    ...
    labels, rois, bbox_targets, gtboxes = _sample_rois(all_rois, gt_boxes, fg_rois_per_image,
                                                       rois_per_image, cfgs.CLASS_NUM+1, fg_threshold, stage)
...
def _sample_rois(all_rois, gt_boxes, fg_rois_per_image,
                 rois_per_image, num_classes, fg_threshold, stage):
    ...
    bbox_target_data = _compute_targets(
        rois, gt_boxes[gt_assignment[keep_inds], :-1], labels, stage)
